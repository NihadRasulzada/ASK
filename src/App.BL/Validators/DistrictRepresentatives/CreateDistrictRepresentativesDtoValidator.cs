...
public class CreateDistrictRepresentativesDtoValidator : AbstractValidator<CreateDistrictRepresentativesDto>
{
    public CreateDistrictRepresentativesDtoValidator(ILanguageService languageService)
    {
