...
namespace App.BL.Validators.Exhibition;

public class UpdateExhibitionDtoValidator : AbstractValidator<UpdateExhibitionDto>
{
    ...
    public UpdateExhibitionDtoValidator(ILanguageService languageService)
    {
        RuleFor(x => x.Title)
