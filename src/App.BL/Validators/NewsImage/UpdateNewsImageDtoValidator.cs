...
public class UpdateNewsImageDtoValidator : AbstractValidator<UpdateNewsImageDto>
{
    ...
    public UpdateNewsImageDtoValidator(ILanguageService languageService)
    {
        RuleFor(x => x.Id)
            .NotEmpty().WithMessage(ValidationMessages.IdRequired(languageService.Lang));
