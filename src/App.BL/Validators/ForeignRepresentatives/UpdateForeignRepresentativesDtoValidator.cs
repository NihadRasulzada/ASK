...
public class UpdateForeignRepresentativesDtoValidator : AbstractValidator<UpdateForeignRepresentativesDto>
{
    public UpdateForeignRepresentativesDtoValidator(ILanguageService languageService)
    {
