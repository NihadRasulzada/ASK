...
public class TrainingMapper(ILanguageService languageService, IMediaUrlBuilder mediaUrlBuilder) : ITrainingMapper
{
    ...
    public TrainingResponseDto DomainToResponseDto(Core.Entities.Training entity)
    {
        ...
        return new TrainingResponseDto(entity.Id, title, mediaUrlBuilder.BuildHtml(text), mediaUrlBuilder.Build(entity.TitleImageUrl.ObjectKey), entity.IsDeactive, entity.Created);
    }
    public TrainingDateResponseDto DomainToResponseDateDto(Core.Entities.Training entity)
    {
        ...
        return new TrainingDateResponseDto(entity.Id, title, mediaUrlBuilder.BuildHtml(text), mediaUrlBuilder.Build(entity.TitleImageUrl.ObjectKey), entity.IsDeactive, entity.Created, entity.StartDate, entity.EndDate);
    }
