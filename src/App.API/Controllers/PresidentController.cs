...
{
    /// <summary>
    /// Prezident məlumatlarının siyahısını qaytarır.
    /// </summary>
    ...
    [HttpGet]
    [ProducesResponseType(typeof(PagedDataResponse<IEnumerable<PresidentResponseDto>>), StatusCodes.Status200OK)]
    ...
    /// </summary>
    /// <param name="id">Prezident məlumatının unikal identifikatoru.</param>
    /// <param name="cancellationToken">Ləğvetmə tokeni.</param>
    ...
    /// </summary>
    /// <param name="dto">Yaradılacaq məlumatlar (multipart/form-data).</param>
    /// <param name="cancellationToken">Ləğvetmə tokeni.</param>
    ...
    /// <param name="dto">Yenilənmiş məlumatlar (multipart/form-data).</param>
    /// <param name="cancellationToken">Ləğvetmə tokeni.</param>
    /// <returns>Yenilənmiş prezident DTO-su.</returns>
