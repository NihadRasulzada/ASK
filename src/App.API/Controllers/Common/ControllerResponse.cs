...
/// </summary>
public class ValidationErrorResponse(string message, IEnumerable<CustomValidationError> errors)
{
    /// <summary>
    /// Indicates if the operation was successful
    /// </summary>
    ...
    /// }
    /// </example>
    public IEnumerable<CustomValidationError> Errors { get; set; } = errors;
}
...
public class PaginationMetadata(int pageIndex, int pageSize, int totalCount, int totalPages, bool hasPreviousPage, bool hasNextPage)
{
