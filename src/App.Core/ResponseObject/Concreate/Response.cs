...
public class Response : IResponse
{
    ...
    public bool IsSuccess => ResponseStatusCode == ResponseStatusCode.Success;
    public bool IsFailure => !IsSuccess;

    public int HttpStatusCode => ResponseStatusCode switch
    {
    ...
    public static Response Error(string message)
        => new(ResponseStatusCode.Error, message);
