...
namespace App.Core.ResponseObject.Concreate;
...
public class PagedResponse<T> : Response<T>
{
    ...
    public static PagedResponse<T> Create(T data, int pageIndex, int pageSize, int totalCount, string message)
        => new(data, pageIndex, pageSize, totalCount, message);

    public static PagedResponse<T> CreateWithMetadata(T data, int pageIndex, int pageSize, int totalCount, Dictionary<string, object> metadata)
    {
