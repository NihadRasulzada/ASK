...
public static class ResponseExtensions
{
    ...
    /// </summary>
    public static Response<TResult> Map<T, TResult>(this IResponse<T> response, Func<T, TResult> mapper)
    {
        if (response.IsSuccess && response.Data != null)
        {
    ...
    /// </summary>
    public static Response<TResult> Bind<T, TResult>(this IResponse<T> response, Func<T, Response<TResult>> func)
    {
        if (response.IsFailure)
        {
            return new Response<TResult>((Response)response, default(TResult));
